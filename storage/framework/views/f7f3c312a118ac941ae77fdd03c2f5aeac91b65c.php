...
<!--      <p>-->
<!--        STAGE 1 – has two phases PRELAUNCH. The FONEPO Prelaunch process phase1 open website phase2-->
...
<!--      </p>-->
<!--      <p>-->
<!--        STAGE 2 – FONEPO will LAUNCH, fomo(watch video, gameplay, complete tasks, click views, and online-->
<!--        gaming players), and open global partners. And FONEPO enters full operational mode. The revolutionary-->
<!--        recurring bonus systems are activated and all members can now invite friends from all over the world.-->
<!--      </p>-->
<!--      <p>-->
<!--        STAGE 3 – FONEPO will LAUNCH, Ebusiness activated Eshop, future market, distribution token, and investment option.-->
<!--      </p>-->
<!--      <p>-->
<!--        STAGE 3 – FONEPO will LAUNCH, crypto loan, activated transfer, exchange, and investment option.-->
<!--      </p>-->
<!--    </div>-->
<!--  </div>-->
<!--</div>-->
                ...
                <div class="col-lg-6">
                    ...
                    <div class="ap-title">
                        ...
                        <p class="my-4"  style="color: #707079;">
                         ...
                         Fonepo	open  full operated and activated Future AI BOT Ebusiness Eshop, Future booking.
...
<!--FOM Right/ Reserved credit coins for  DURING PRELAUNCH The earlier you join and activated  fc account in period pre prelaunch, the more beneficial for program -->
<!--you will get second dashboard, already  upgrade VIP2, Get reward for 100 000ads /projects/ bring by client / complete uploaded worldwide  each  get 0.009%, more-->
<!--feature activated, as the coin will steadily increase in value soon as possible . The FOM will only be available during the prelaunch and with the growth during prelaunch -->
<!--and directly after launch the  value more growth-->
...
<?php /**PATH /home/afonliww/public_html/resources/views/home/project.blade.php ENDPATH**/ ?>