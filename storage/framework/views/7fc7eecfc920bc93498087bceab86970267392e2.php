...
$subscibe=DB::select("SELECT * from latests order by id desc");
    ?>       
        <div class="table-container rounded ">
                    ...
                    <p class="text-center font-weight-bold table-title">Subscribed  user   <span class="text-success">(<?php echo e(count($subscibe)); ?>)</span></p>
                  </div>

                  <div class="tb">
                    <?php if(count($subscibe)): ?>
...
// $year = date("Y-m-d", strtotime($row->email_verified_at));
                         ...
                         <tbody>
                            <tr>
                                ...
                                <td><?php echo e($$subscibe->email); ?></td>

                                
                                <td><?php echo e($$subscibe->created_at); ?></td>
                            </tr>
                        </tbody>
                        <!-- <?php echo e($n++); ?> -->
                        <?php endforeach;  ?>
 ...
 <?php echo $__env->make('user.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laraver pro\git\resources\views/admin/user-subscribe.blade.php ENDPATH**/ ?>