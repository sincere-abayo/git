    ...
    <div class="row">
        <div class="deposit-form col-md mx-md-2 px-lg-3 px-xl-5">
          <h3 class="text-center">Deposit Amount </h3>
           <?php if($ammount): ?>  <span class="btn btn-secondary"><?php echo e($ammount); ?></span><?php endif; ?> 
            <?php if(session('message')): ?>
                ...
                <?php endif; ?>
          <form id="depositForm" method="post" action="<?php echo e(route('user.deposit')); ?>">
              <?php echo csrf_field(); ?>
...
<?php /**PATH D:\laraver pro\git\resources\views/user/balance/deposit.blade.php ENDPATH**/ ?>