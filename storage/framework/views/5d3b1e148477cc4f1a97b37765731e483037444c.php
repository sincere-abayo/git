    ...
    <div class="container">
        ...
        <div class="card-container my-2">
            <div class="mainCard card1">
                <div class="title">
                    <h3 class="font-weight-bold text-3xl"><?php echo e($ads->tittle); ?></h3>
                </div>
                <div class="app-rej">
                    
                    <button class="btn btn-danger rejectBtn">reject</button>
                    <a href="<?php echo e(route('admin.ads.approve')); ?>?id=<?php echo e($adsId); ?>" class="btn btn-primary">approve</a>
                        <span class="bg bg-success"><?php echo e($rejected); ?></span>
                        <span class="bg bg-success"><?php echo e($message); ?></span>
                                      </div>
                <div class="img">
                    <img src="<?php echo e(asset('ads/'.$ads->banner)); ?>" alt="">
                </div>  
                <div class="descp">
            ...
            <div class="mainCard card2">
                <div class="d-flex justify-content-between align-items-end ">
                    ...
                    <p class="text-primary font-semibold"><?php echo e($ads->user); ?></p>
                </div>
                ...
                <p class="role"></p>
                    ...
                    <div class="text-blue-500 font-semibold"><?php echo e($ads->status); ?></div>
                </div>
                    <?php if($ads->status=='rejected'): ?>
                <h3 class="sub-head text-center">Rejected Reason</h3>
                <p class="qtn text-center"><?php echo e($ads->rejected_reason); ?></p>
                <hr><?php endif; ?>
                <h3 class="sub-head text-center">Ads Question</h3>
                <p class="qtn text-center"><?php echo e($ads->question); ?></p>

<?php if($ads->url): ?>
                <div class="bg-gray-200 py-4 px-2">
                    <div class="url bg-white shadow-md d-flex align-items-center rounded-lg">
                        <div class=" text-gray-500 link"><?php echo e($ads->url); ?></div>
...
<?php endif; ?>
                <div class="views d-flex justify-content-between">
                    ...
                    <div class="view-icon font-weight-bold"><i class="lar la-eye"></i> <?php echo e($ads->targeted_views); ?></div>
                    </div>
                    <div class="reacted d-flex flex-column align-items-center">
                        <div class="font-semibold text-center">Reached Views</div>
                    <div class="view-icon font-weight-bold"><i class="lar la-eye"></i> <?php echo e($ads->reached_views==NULL?0:$ads->reached_views); ?></div>
                ...
                <div class="views d-flex justify-content-between">
                 ...
                 <div class="paidMoney d-flex justify-between align-center my-2">
                    ...
                    <div class="text-blue-500 font-semibold"><?php echo e($ads->targeted_duration); ?> days</div>
                </div>
                <div class="paidMoney d-flex justify-between align-center my-2">
                    <div class="font-semibold">Money Paid to ad</div>
                    <div class="text-blue-500 font-semibold"><?php echo e($ads->total_paid); ?>$</div>
                </div>
                <div class="paidMoney d-flex justify-between align-center my-2">
                    <div class="font-semibold">Location</div>
                    <div class="text-blue-500 font-semibold"><?php echo e($ads->location); ?></div>
                </div>
...
<div class="reject bg-white rounded-xl shadow-lg py-2 px-4 " id="reject">
                ...
                <div class="text-center">
                    <form method="post" action="<?php echo e(route('admin.ads.reject')); ?>">
                        <?php echo csrf_field(); ?>
                        <input type="text" name="reason" 
                            class="shadow appearance-none border border-red-500 rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline"
                            placeholder="reason" required>
                            <input type="hidden" name="ads" value="<?php echo e($adsId); ?>" >
                                   </div>
                <div class="actions">
...
<?php /**PATH B:\node tot\esmscript\git\resources\views/admin/fomo/adsDetail.blade.php ENDPATH**/ ?>