...
$requested=DB::select("SELECT * from latests order by id desc");
    ?>       
        <div class="table-container rounded ">
                    <div class="pt-3 border">
                    <p class="text-center font-weight-bold table-title">Subscribed  user   <span class="text-success">(<?php echo e(count($requested)); ?>)</span></p>
                  </div>
...
// $year = date("Y-m-d", strtotime($row->email_verified_at));
                         ...
                         <tbody>
                            <tr>
                                ...
                                <td><?php echo e($requested->created_at); ?></td>
                            </tr>
                        </tbody>
                        <!-- <?php echo e($n++); ?> -->
                        <?php endforeach;  ?>
