...
<style>
 #afo1{
  ...
  @media (max-width: 868px) and (max-height: 851px) {
      ...
      .img{
         ...
         <div class="hello-content">
                 <h3>
                    fonepo have created unique innovative 
  ...
  <!--                  <p class="float-right hero-text" style="font-size:25px" id="afo">fonepo have created unique innovative <br>affiliate -->
  ...
  <!--                  </p>-->
  <!--<p style="font-size:25px" id="afo1">fonepo have created unique <br>innovative affiliate -->
...
<div class="getBonus">
     <div class="regAds shadow">
        ...
        <div class="regBtn">
            <h2>Register <br> FC now</h2>
            <button class="getMore"><a >Get more</a></button>
        </div>
    </div>
</div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        <span class="icon d-block">
                            ...
                            <p class="par">At fonepo, it is a unique platform where you can earn by performing simple tasks like clicking views, watching videos, referring new members, and completing offers.</p>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <span class="icon d-block">
                            ...
                            <h3 class="text-uppercase h4 mb-3 font-weight-bold">Online Shop</h3>
...
<!-- <section class="video-section co-lg-5 ">
        <div class="container">
            <div class="row">
                ...
                <div class="col-3">
                    <p>At fonepo is unique platform you can earn option you wantsimple task ,click views,
                    ...
                    <div class=" mb-2">
                        <div class="col-md-12 text-center" data-aos="fade">
                            ...
                            <h3 class="site-section-heading text-uppercase text-center font-secondary text-white" style="" >
                                fonepo - The Future Of Internet User</h3>
      ...
      <div class="text-center">
        <ul class="list-unstyled">
         <li class="list-item">
          ...
          <li class="list-item">
            <img src="https://cdn-icons-png.flaticon.com/128/5805/5805536.png" style="width:28px;height:28px;" alt="Image">
...
<?php /**PATH /home/afonliww/marathon.fonepo.com/f/resources/views/home/welcome.blade.php ENDPATH**/ ?>