                    ...
                    <div class="ref-data"> 
                        ...
                        <div class="ref-info">
                            ...
                            <div class="ref-info-content">  
                                ...
                                <input type="hidden" id="link" value="https://marathon.fonepo.com/f/public/register?referral=<?php echo e($ref_code); ?>">
                              <?php if($activated!='standard'): ?>
                                  <a href="#" style="color: white;text-decoration: none;"  id="btn1"> https://marathon.fonepo.com/f/public/register?referral=<?php echo e($ref_code); ?></a>
                                  <?php else: ?>
                                  <a href="#" style="color: white;text-decoration: none;"  id="btn1"> https://marathon.fonepo.com/f/public/register?referral=*******</a>
                                <?php endif; ?>
...
<?php /**PATH /home/afonliww/marathon.fonepo.com/f/resources/views/user/referral.blade.php ENDPATH**/ ?>