     ...
     <div class="ad-main-box mt-3 mb-3">
         ...
         <div class="ad-sub-box1 ">
                ...
                <div class="sub-box-1">  
                    ...
                    <div class="ad-box bg-danger"><a class="nav-icon fas fa-bookmark" href="#"  href="<?php echo e(route('admin.fc1')); ?>"> <br>FC $100 <br><?php echo e($fc1); ?></a>  </div>   
                </div>
         ...
         <div class="ad-sub-box2">
            <div  class="sub-box-1">
                <div class="ad-box bg-warning mr-2 ml-1"><a class="nav-icon fas fa-money" href="#"  href="<?php echo e(route('admin.fc2')); ?>"> <br>FC $200<br /><?php echo e($fc2); ?></a></div>
...
<?php /**PATH C:\Users\Andela\Documents\WEB DEVELOPMENT\Sincer\New\affiliate.muhahe.com\resources\views/admin/fc2.blade.php ENDPATH**/ ?>