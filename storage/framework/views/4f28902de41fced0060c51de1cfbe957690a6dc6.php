...
<a href="#" style="color:red;text-decoration:none;">
  ...
  <?php endif; ?>
                                            ...
                                            <div class="input-group">
                                                  <?php if($package!='standard'): ?>
                                                <input type="text" id="link"value="http://marathon.fonepo.com/f/public/register?referral=<?php echo e($ref_code); ?>"
                                              class="form-control" readonly class="form-control">
                                              <?php else: ?>
                                                <input type="text" id="link"value="http://marathon.fonepo.com/f/public/register?referral=*******"
...
<?php /**PATH /home/afonliww/marathon.fonepo.com/f/resources/views/user/dashboard.blade.php ENDPATH**/ ?>