...
<style type="text/css">
      ...
      <div class="row" id="rwa">
        ...
        <div class="sub_askHelp">   
             <div class="d-flex adminHelp shadow justify-content-around align-items-center">
                <div style="font-size: 20px;">Contact admin </div>
                <div><i class="las la-hand-point-right text-lg" style="font-size: 25px"></i> </div>
                <div><a href="mailto:info@afonete.com" class="text-primary" style="font-size: 20px;">admin@fonepo.com</a></div>
            </div><div class="or font-weight-bold my-2">OR</div>
            <br>
            <div class="d-flex adminHelp shadow justify-content-around align-items-center">
                <div style="font-size: 20px;">Consult </div>
                <div><i class="las la-hand-point-right text-lg" style="font-size: 25px"></i> </div>
                <div><a href="mailto:info@afonete.com" class="text-primary" style="font-size: 20px;">Livechat</a></div>
            </div>
...
<?php endif; ?>
<?php /**PATH /home/afonliww/public_html/resources/views/auth/register.blade.php ENDPATH**/ ?>