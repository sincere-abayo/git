...
<div class="content-wrapper py-5" style="width: 70%;">
    ...
    <div class="prof-update" >
        <h2 class="upd-title">Admin Profile Update</h2>
            ...
            <div class="row upd-row">   
                ...
                <div class="col-lg-8">
                        <div class="container-fluid">
                            <?php if(!$show): ?>
                            <form action="<?php echo e(route('admin.profile.updates')); ?>" method="post">
                                <?php echo csrf_field(); ?>
                         ...
                         <center>  
                        <a s href="<?php echo e(route('admin.password.show')); ?>" tyle="color: red;">change password</a></center>
...
<?php endif; ?>
                        ...
                        <form action="<?php echo e(route('admin.password.update')); ?>" method="post" class="pb-5">
                            <?php echo csrf_field(); ?>
                          <!--   <div class=" form-group">
                                <label for="profile-pic">Profile Picture:</label>
                                <input type="file" id="profile-pic" name="pic">
...
</div><?php /**PATH B:\node tot\esmscript\git\resources\views/admin/profile-component.blade.php ENDPATH**/ ?>