            ...
            <div class="card-body">
                <h5 class="card-title mb-3">
                   REQUEST TO JOIN STATUS
                              ...
                              <p class="card-text"> Your request to join Fonepo on <u><?php echo e($email); ?></u> has been accepted and it is on waiting. You will receive acceptance email once you will be accepted. This action takes 2hr-48hr normal.
            </div>
        ...
        <div class="text-center" style="width: 80%">
            <div class="card-body">
                ...
                <div style="color: green" class=" mb-4 font-medium text-sm">
                    A new verification link has been sent to the <u><?php echo e($email); ?></u>
                </div> 
                <?php else: ?><p class="card-text">Thanks for signing up! Before getting started, verify your email address
                    by clicking on the link we just emailed to you? If you didn't receive the email on <u><?php echo e($email); ?></u>, we will gladly send
                    you another</p>
                <?php endif; ?>
...
</html><?php /**PATH D:\laraver pro\git\resources\views/auth/verify-email.blade.php ENDPATH**/ ?>