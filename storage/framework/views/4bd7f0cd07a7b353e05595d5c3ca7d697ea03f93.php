    ...
    <div class="content-header">
      <div class="container-fluid">
       <!--  <ul class="nav nav-tabs">
          ...
          <h3> Upload project : Advertise on Afonete</h3></center>
      </div><!-- /.container-fluid -->
    </div>
    <!-- /.content-header -->
        ...
        <div class="col-md-4">
            ...
            <div class="card-body ">
              <div class="info bg-secondary">
                ...
                <!-- /.info-box-content -->
              <div>
                                 <img style="margin-top: -25px;" src="<?php echo e(asset('assets/a/img/click.png')); ?>">
...
<a href="<?php echo e(route('user.dashboard.ptc')); ?>"> MANAGE A PTC AD</a>
        </div>
</center>
                    <br>
                  </div>
         ...
         <div class="col-md-4">
          ...
          <div class="card-body">
            <div class="info bg-secondary">
              ...
              <!-- /.info-box-content -->
             <div>
                 <img style="margin-top: -10px;" src="<?php echo e(asset('assets/a/img/video.png')); ?>">
...
<a href="<?php echo e(route('user.dashboard.video')); ?>">
                    MANAGE VIDEO AD
 ...
 <div class="text-center"><h4 class="font-size-20 font-weight-600">Paid to Downloads (PTD)</h4> <span class="font-size-12 ">Drive traffic to your website, get views on your App.</span></div>
                ...
                <!-- /.info-box-content -->
        <div> <center><img style="margin-top: -30px;"src="<?php echo e(asset('assets/a/img/download.png')); ?>" width="200px" height="200px"></center>
</div>
 ...
 </div><?php /**PATH /home/afonliww/marathon.fonepo.com/f/resources/views/user/project/project.blade.php ENDPATH**/ ?>