                            ...
                            <div class="row">
                                    ...
                                    <div class="card"> 
                                         <div class="card-body" style="padding-bottom: 7px;">
                                             <form  action="<?php echo e(route('validate')); ?>" method="POST" >
                                               ...
                                               <div style="color:aque;" class="text-center text-danger p-0"><?php echo e($message); ?></div>
                                               <?php else: ?>
                                ...
                                <!--<div class="col">
                                      ...
                                      <center>
                                           ...
                                           <?php if(!empty($message)): ?>
                                           <span style="color:aque"> <?php echo e($message); ?></span>
                                           <?php else: ?>
...
<?php /**PATH D:\laraver pro\git\resources\views/user/user-package.blade.php ENDPATH**/ ?>