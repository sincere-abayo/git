...
<div class="content-wrapper"  style="width: 82%;background: #1c1d20; color: #888b95;">
    ...
    <div class="container">
        ...
        <div class="tabs tab_links mt-2">
            <span class="links_tabs d-flex " >
                <a href="<?php echo e(route('admin.ads')); ?>" style="color:white"class="fomoLink"  id="tabs"> <i
                        class="fa-solid fa-rectangle-ad"></i> Manage ads </a>
                <a href="<?php echo e(route('admin.ads.create')); ?>"style="color:white" class="fomoLink"><i class="fa-solid fa-plus"></i> Add
                    ads </a>
  ...
  <form id="adForm" method="post" action="<?php echo e(route('admin.ads.created')); ?>" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
  <div>
...
<li>No x-rated adult content.</li></ul>
 ...
 </div><?php /**PATH D:\laraver pro\git\resources\views/admin/add-ads.blade.php ENDPATH**/ ?>