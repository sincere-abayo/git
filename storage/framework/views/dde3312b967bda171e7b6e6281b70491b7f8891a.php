                  ...
                  <center>
                    <div class="text-center ">
                      <h4 class="font-size-20 font-weight-600">
                         <?php if($row->url!=NULL): ?>
                 <a style="color: yellow" href=" <?php echo e($row->url); ?>"><?php echo e($row->tittle); ?>
...
$view=$views->reached_views>0?$views->reached_views:'0';
    // $remaining=$views->targeted_views-$views->reached_views;
              ...
              <?php if($row->banner!=NULL ): ?>
                  <?php 
                  echo " <img src='".asset('ads/'.$row->banner)."' style='width:100%;height:180px;' style='margin-top:-20px'>";
                  ?>     
...
<!-- /.container-fluid -->
 ...
 </div><?php /**PATH /home/afonliww/marathon.fonepo.com/f/resources/views/user/project/myptc.blade.php ENDPATH**/ ?>