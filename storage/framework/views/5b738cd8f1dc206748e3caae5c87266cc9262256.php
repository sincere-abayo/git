 ...
 <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        ...
        <li><a  href="<?php echo e(route('user.dashboard.advertisment')); ?>">Watch Videos</a></li>
        <li><a  href="<?php echo e(route('user.dashboard.advertisment')); ?>">Download App <i style="color: red">Coming soon</i></a></li>
      </div><!-- /.container-fluid -->
    </div>
    <!-- /.content-header -->
...
$results=db::SELECT("SELECT * from ads");
if (count($results)) {
...
</div><?php /**PATH /home/afonliww/marathon.fonepo.com/f/resources/views/user/fearloss/payclick.blade.php ENDPATH**/ ?>