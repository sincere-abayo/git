...
<link rel="stylesheet" href="https://maxst.icons8.com/vue-static/landings/line-awesome/line-awesome/1.3.0/css/line-awesome.min.css">
 ...
 <div class="content-wrapper right-side" style="width: 80%;"> 
        ...
        <?php $results=DB::select("SELECT * from users where utype != 'ADM' and email_verified_at IS NOT NULL  and has_request !='requested'");
         ...
         <div class="ad-sub-box2">
            ...
            <div class="sub-box-1">   
             ...
             <div class="table-container rounded ">
                    ...
                    <p class="text-center font-weight-bold table-title">Pending User <span class="text-success">(<?php echo e(count($result)); ?>)</span></p>
                  </div>
                         ...
                         <tbody>
                            ...
                            $i=1;
                                ...
                                foreach ( $result as $users) { 
                                    $year = date("Y-m-d", strtotime($users->created_at));
                                    ?>
                                          <tr>
                                               <td><?php echo e($i++); ?></td>
...
<?php /**PATH B:\node tot\esmscript\git\resources\views/admin/pending_users.blade.php ENDPATH**/ ?>