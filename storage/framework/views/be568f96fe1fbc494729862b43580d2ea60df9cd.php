...
<div class="content-wrapper"  style="width: 82%;background: #1c1d20; color: #888b95;">
    ...
    <div class="container">
        ...
        <div class="tabs tab_links mt-2">
            <span class="links_tabs d-flex " >
                <a href="<?php echo e(route('admin.video')); ?>" style="color:white"class="fomoLink"  id="tabs"> <i
                        class="fa-solid fa-rectangle-ad"></i> Manage video </a>
                <a href="<?php echo e(route('admin.video')); ?>"style="color:white" class="fomoLink"><i class="fa-solid fa-plus"></i> Add
                    Video </a>
  ...
  <form id="adForm" method="post" action="<?php echo e(route('admin.video.create')); ?>" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
  <span>
   ...
   <!-- 60MB in bytes -->
    ...
    <div class="">
      <tr class="user-box-add">
        <td>
          <input type="text" id="titt" oninput="changetittle(this.value)"  name="tittle" maxlength="25" value="<?php echo e($ads->tittle??''); ?>" placeholder="ex: watch and earn" required="" class="form-control"><br>
        </td>
        <td>
   ...
   <div class="user-box">
    ...
    <div class="user-box">
      <tr>
        <td>
          <input type="text" id="question" value="<?php echo e($ads->question??''); ?>" placeholder="ex: what color on my banner" name="question"  maxlength="60" required="" class="form-control"><br>
        </td>
        <td>
     ...
     <div class="user-box">
      <tr>
        ...
        <td>
          <input type="number" id="time"  name="time" value="<?php echo e($ads->time??''); ?>" placeholder="time in seconds ex: 10" maxlength="60" required="" class="form-control"><br>
        </td>
         <td>
   ...
   <button class="btn btn-success" type="submit">Create and approve video</button>
...
<p>You can pay VIDEO ads with your ammount on balance, or you can <a href="<?php echo e(route('user.dashboard.deposit')); ?>" style="color:red">Deposit</a> to add ammount to your balance.</p>
                </div>
...
<li>No x-rated adult content.</li></ul>
 ...
 </div><?php /**PATH B:\node tot\esmscript\git\resources\views/admin/add-video.blade.php ENDPATH**/ ?>