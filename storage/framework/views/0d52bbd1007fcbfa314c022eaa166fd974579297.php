        ...
        <div>
             ...
             <div class="ad-sub-box1 ">
                    <div class="sub-box-1">   
                        ...
                        <?php if($package1=='ft'): ?> 
                        <div class="ad-box bg-success"> <a href="<?php echo e(route('user.dashboard.activate')); ?>" class="nav-icon fas fa-window-restore" ><br>Activate <br> package</a></div> <?php endif; ?>
                        <?php if($package1=='fc1' || $package1=='fc2'): ?> 
                        <div class="ad-box bg-success"> <a href="#" class="nav-icon fas fa-window-restore" ><br>Package  <br> Activated</a></div>
                        <?php endif; ?>
                    </div>
                    <div class="sub-box-1">  
...
<a href="#" style="color:red;text-decoration:none;">
  ...
  <?php endif; ?>
                                            ...
                                            <div class="input-group">
                                                  <?php if($package!='standard'): ?>
                                                <input type="text" id="link"value="http://fonepo.com/register?referral=<?php echo e($ref_code); ?>"
...
<?php /**PATH D:\laraver pro\git\resources\views/user/dashboard.blade.php ENDPATH**/ ?>