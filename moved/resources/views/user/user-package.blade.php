                    ...
                    if (count($deposit))
{
             ...
             <div class="ad-sub-box2">
                ...
                <div class="sub-box-1">   
                     <div class="ad-box bg-success col"><a class="nav-icon fas fa-gift" href='#'> <br>Reserved_ads<br>100000</a></div><br> 
                </div>
    ...
    <div class="modal-dialog modal-xl modal-dialog-scrollable" role="document">
        <div class="modal-content" style="background: linear-gradient(190deg, #2ecd71 60%, #27ae60 40.1%); color: black; width: 80%; margin: 0 auto;">
            <div class="flex justify-content-between mb-4 fc_container"">
                ...
                <br><center>
                <span class="bg-danger ">{{$error??''}}{{$back??''}}</span>
                </center>
                            ...
                            <div class="row">
                                    ...
                                    <div class="card mb-4">
                                        <div class="card-body">
                                            ...
                                            <div class="text-center mt-3">
                                                <a href="{{route('fc1')}}"><button class="btn btn-primary" value="100"> BUY NOW</button></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card"> 
                                         <div class="card-body" style="padding-bottom: 7px;">
                                             <form  action="{{ route('validate') }}" method="POST" >
                                               ...
                                               <label class="w-100">
                                               @if(!empty($message))
                                               <div style="color:aque;" class="text-center text-danger p-0">{{$message}}</div>
                                               @else
                                               <div class="bg-danger" style="width:100%;">
                                                    <div style="color:white; padding: 6px 7px; text-align:center;" >Do yo have activation code?</div>
                                                </div>
                                               
                                               @endif
                                               </label>
                                               <input type="text" name="code" placeholder="code" class="verifyInput">
                                               <center><input type="submit"class="btn btn-primary"  value="verify code"></center> 
                                ...
                                <!--<div class="col">
                                      ...
                                      <center>
                                           ...
                                           @if(!empty($message))
                                           <span style="color:aque"> {{$message}}</span>
                                           @else
                                           <span style="color:green">Do yo have activation code?</span>
                                           @endif
                                           <br> 
                                           <input type="text" name="code" placeholder="code" style="color:black">
                                           <br><input type="submit"class="btn btn-primary"  value="verify code"></label>
                                           <label>
                                           </form>
                                       </center>
                                    </div>
