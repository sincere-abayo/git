...
<div>
    ...
    <div class="container privacy pt-5">
        ...
        <ul>
            ...
            <li>
              WE need local and world wide partners to live the dreams, transform fonepo   into one of the most popular platform globally.
            </li>
        </ul>
...
has priority for other feature after launch according step of part launched huge benefits after full launch feature waiting you.
        ...
        <p>CONNECT WITH US  Work the way you want, earn the way you want and most importantly , live the way you want</p>

        <p class="font-weight-bold">•Take well This is your own business, Building together, WE WILL LIVE DREAMS TOGETHER
</p>
