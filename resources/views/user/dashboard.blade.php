        ...
        <div>
             ...
             <div class="ad-sub-box1 ">
                    <div class="sub-box-1">   
                        ...
                        @if($package1=='ft') 
                        <div class="ad-box bg-success"> <a href="{{route('user.dashboard.activate')}}" class="nav-icon fas fa-window-restore" ><br>Activate <br> package</a></div> @endif
                        @if($package1=='fc1' || $package1=='fc2') 
...
<a href="#" style="color:red;text-decoration:none;">
  ...
  @endif
                                            ...
                                            <div class="input-group">
                                                  @if($package!='standard')
                                                <input type="text" id="link"value="http://fonepo.com/register?referral={{$ref_code}}"
