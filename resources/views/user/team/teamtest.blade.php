...
$i=1;
$a=1;
    $access=DB::SELECT("SELECT * from users where referee_id='$ref' and has_paid_package !='no'");
        $check=count($access);
                            ...
                            <div class="d-flex justify-content-between align-items-center ml-3 mr-4" >
                                ...
                                <div class="inviteContainer">
                                    ...
                                    <div class="invite" id="invite_form">
                                        <form method="post" action="{{route('club.invite')}}">
                                            @csrf
...
//                   LIMIT 10");
 $most=DB::SELECT("SELECT * from clubs limit 6"); 
$a=1;
?>
                                         ...
                                         <!-- Add font awesome icons -->
                                            <div class="px-3 d-flex justify-content-start align-items-center ">  
                                                    ...
                                                    <div class="link-icon">  
                                                        ...
                                                        <div class="ml-3"><a href="#?club={{$club1->id}}">{{$club1->tittle}}</a></div>
                                                    </div>
                                              <hr>
 ...
 @endforeach  
                                              ...
                                              @else
                                         no most clubs are availlable right now.be the first to create it
                                         @endif
...
<?php $all=DB::SELECT("SELECT * from clubs"); $e=1;?>
                        ...
                        <div class="card direct-chat direct-chat-primary px-2 ">
                                 ...
                                 <div class="card-body">
                                       ...
                                       @foreach($all as $one)
                                         ...
                                         <!-- Add font awesome icons -->
                                            <div class="px-3 d-flex justify-content-start align-items-center ">  
                                                    ...
                                                    <div class="link-icon">  
                                                        <div><img src="{{asset('assets/a/img/club.png')}}" class="links "></div> 
                                                        <div class="ml-3"><a href="#?club={{$one->id}}">{{$one->tittle}}</a></div>
                                                    </div>
                                     ...
                                     @endforeach
                                              ...
                                              @else
                                         no clubs are availlable right now.be the first to create it
                                         @endif
                                         <hr>   </div>
                             </div>
...
@endif
            ...
            <div class="my-3">
                <div class="clubBox w-md-50">
                 @if(request()->query('club'))
                  <script>
        // Call the function when the condition is true
        openTabContent(event, 'myClub');
    </script>
                 <?php $id=request()->query('club'); $clubs1=DB::SELECT("SELECT * from clubs where id='$id'"); $club1=$clubs1[0]; $size=count($clubs1);?>
                    <div class="d-flex align-items-center flex-column">
                        <div class="clubImg"><img src="{{asset('assets/a/img/club.png')}}" class="links "></div> 
                        <div class="clubTitle">{{$club1->tittle}}</div>
                        <div class="clubDetails">{{$club1->desc}}</div>
                    </div>
                    

                    <div class=" rounded clubNums">
                        <div class="team_leader d-flex justify-content-between">
                            <div>Club founder</div>
                            <div>{{$club1->user}}:</div>
                        </div>
...
<script>
    ...
    btn1.onclick = function(){
        var check="{{$check}}";
    //   var test="{{$ref}}"; test =parseInt(test);
        var intValue = parseInt(check);
        var rem=5-intValue;
        if (intValue<5)
        {
