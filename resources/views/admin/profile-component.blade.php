            ...
            <div class="row upd-row">   
                ...
                <div class="col-lg-8">
                        <div class="container-fluid">
                            @if(!$show)
                            <form action="{{route('admin.profile.updates')}}" method="post">
                                @csrf
                         ...
                         <center>  
                        <a s href="{{route('admin.password.show')}}" tyle="color: red;">change password</a></center>
                        ...
                        <form action="{{route('admin.password.update')}}" method="post" class="pb-5">
                            @csrf
                          <!--   <div class=" form-group">
                                <label for="profile-pic">Profile Picture:</label>
                                <input type="file" id="profile-pic" name="pic">
