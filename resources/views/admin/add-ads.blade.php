...
<div class="content-wrapper"  style="width: 82%;background: #1c1d20; color: #888b95;">
    ...
    <div class="container">
        ...
        <div class="tabs tab_links mt-2">
            <span class="links_tabs d-flex " >
                <a href="{{ route('admin.ads') }}" style="color:white"class="fomoLink"  id="tabs"> <i
                        class="fa-solid fa-rectangle-ad"></i> Manage ads </a>
                <a href="{{ route('admin.ads.create') }}"style="color:white" class="fomoLink"><i class="fa-solid fa-plus"></i> Add
                    ads </a>
  ...
  <form id="adForm" method="post" action="{{route('admin.ads.created')}}" enctype="multipart/form-data">
    @csrf
  <div>
      @if($message=='success')
   ...
   <div class="">
      <tr class="user-box-add" id="urli">
        <td>
          <input type="url" name="url" style="color: black;  width: 240px;" id="url" placeholder="ex:http://www.example.com" value="{{$ads->url??''}}"  class="form-control">
            <br>
        </td>
        <td>
...
<div class="" >
   ...
   <button class="btn btn-success" type="submit">Create and Approve ads</button>
