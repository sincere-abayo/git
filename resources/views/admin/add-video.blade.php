...
<div class="content-wrapper"  style="width: 82%;background: #1c1d20; color: #888b95;">
    ...
    <div class="container">
        ...
        <div class="tabs tab_links mt-2">
            <span class="links_tabs d-flex " >
                <a href="{{ route('admin.video') }}" style="color:white"class="fomoLink"  id="tabs"> <i
                        class="fa-solid fa-rectangle-ad"></i> Manage video </a>
                <a href="{{ route('admin.video') }}"style="color:white" class="fomoLink"><i class="fa-solid fa-plus"></i> Add
                    Video </a>
  ...
  <form id="adForm" method="post" action="{{route('admin.video.create')}}" enctype="multipart/form-data">
    @csrf
  <span>
      @if($message=='success')
