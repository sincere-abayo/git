            ...
            <div class="row my-2">
                ...
                <a href="#"
                    ...
                    <div class="mx-2">
                        ...
                        <div class="members" style="font-size: 13px">advertisment:  {{$accepted}}</div>
                    </div>
                  </a>
                ...
                <a href="#"
                    ...
                    <div class="mx-2">
                        ...
                        <div class="members" style="font-size: 13px">advertisment: <span>{{$rejected}}</span></div>
                    </div>
                  </a>
            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class=" tracking-wide text-center text-2xl">
                                            ...
                                            <div class=" absolute right-0 w-48 py-2 mt-2 bg-white bg-gray-100 rounded-md shadow-xl"
                                                id="drop-content">
                                                <a href="{{ route('admin.adsDetail') }}?id={{$ad->id}}"
